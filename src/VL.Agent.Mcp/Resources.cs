...
internal static class Resources
{
    ...
    [
        new(
            "vl-agent://schema/graph-transaction",
        ...
        new(
            "vl-agent://docs/graph-transaction-protocol",
    ...
    public static JsonNode Read(JsonNode? @params)
    {
        ...
        var path = Path.Combine(AgentPaths.DistributionRoot, resource.RelativePath);
        if (!File.Exists(path))
